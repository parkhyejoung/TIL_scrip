...
/* console.log(num2); */
//객체.함수(실행하는값);
//콘솔창에 num2변수값(실행값)을 로그로 출력(실행함수)하겠다
/* console.log(num); */
/* ==========================================2일차 25/5/13 */
var bowl;
bowl = '쌀';
...
bowl = '콩';
/* console.log(bowl); */ /* 콩 */
/* 자바스크립트는 절차적 언어이기 때문에 CSS처럼 우선순위에 따라 최종결과값만 인식하는것이 아닌 실행 함수에 작성 위치에 따라 다른 변수값을 인식할수있다 */
var a = 1;
var b = 5;
var c = 10;
c = a;
console.log(a); /* b의 값 받기 전 a의 기존 값 출력 */
a = b; /* 문자 b가 아닌 변수 b를 a에 대입한다(ㅇ) 변수를 대입한다 == 변수값을 대입한다*/ 
console.log(b);
b = c;
console.log(c);
//=================================자료형 구분 내장함수 typeof
...
console.log('==========데이터공부')
var d;
console.log(typeof d); //값이 할당되지않은 상태 underfined (보통 오류찾기용으로 사용)
d = a;
console.log('d의 값은->'+d);//'d의값은'(+ or ,)d 연결된다 /* '있을시 문자로 취급 없으면 숫자*/
/* console.log('a의 값은',a);
console.log('a의 값은',b);
console.log('a의 값은',c);
console.log('a의 값은',d); */
console.log('------------------------');
console.log(1+1); /* 숫자+숫자 ->더하기결과 */
...
console.log(box4);
box4 = box2+box3;
console.log(box4); /* hello javascript */
/* box4 = null; //값 아예 제거
...
total = num1 + num2; //유지보수 깔끔하게 쓰려면 total 
console.log(total); //30
console.log("she's gone") //she's gone
console.log('-----------------------------------------');
console.log('1+1은 '+(1+1)+'입니다.')//1+1은 2입니다.
//일반 문자와 프로그래밍식을 쉽게 작성할수있게 템플릿 문자열 활용
console.log(`1+1은 ${1+1}입니다.`);
var num4 = 1;
var num5 = 2;
//변수 num4의 값은 1입니다
// num4와 num5 더한 결과값은 3입니다
console.log(`변수 num4의 값은 ${num4}입니다.`);
console.log(`num4와 num5 더한 결과값은 ${num4+num5}입니다.`);
console.log('-------------------------------------');
var subway = 8000;
var coffee = 16000;
var result = subway+coffee;
/* 오늘 총 지출액은 ?원입니다. */
console.log(`오늘 총 지출액은 ${result}원입니다.`); /* 항시 목표를 생각하면서 하기 */
console.log(`------------------------------구구단`);
var dan99 = 9;
//2x1=2
