...
//복제한 요소 붙여넣기(대상 요소의 마지막자식 위치로 붙여넣기)
section.appendChild(ulClone); //section의 마지막자식 위치에 복제대상 붙여넣기(ctrl+v)
...
/* let cssQ = confirm('BOM 웹브라우저에 관련된 기능을 제어할수있게 해주는 객체 집합입니다')
while (htmlQ != false) {
    console.log(cssQ);
}alert('정답입니다!');
